...
#Область РассчетВремениВходаВыхода

Процедура РассчетВремениВходаВыходаРаботников() Экспорт 
	
	Запрос = Новый Запрос;
	Запрос.Текст = 
		"ВЫБРАТЬ ПЕРВЫЕ 50
		|	ДанныеВходаВыходаРаботника.Дата КАК Дата,
		|	ДанныеВходаВыходаРаботника.Организация КАК Организация,
		|	ДанныеВходаВыходаРаботника.РаботникСклада КАК РаботникСклада,
		|	ДанныеВходаВыходаРаботника.ДействиеВходаВыхода КАК ДействиеВходаВыхода,
		|	ДанныеВходаВыходаРаботника.ПризнакОбработки КАК ПризнакОбработки
		|ПОМЕСТИТЬ НеОбработанныеВходы
		|ИЗ
		|	РегистрСведений.ДанныеВходаВыходаРаботника КАК ДанныеВходаВыходаРаботника
		|ГДЕ
		|	НЕ ДанныеВходаВыходаРаботника.ПризнакОбработки
		|	И ДанныеВходаВыходаРаботника.ДействиеВходаВыхода = ЗНАЧЕНИЕ(Перечисление.ДействияВходаВыхода.Вход)
		|
		|УПОРЯДОЧИТЬ ПО
		|	Дата
		|;
		...
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		|	НеОбработанныеВходы.Дата КАК Дата,
		|	НеОбработанныеВходы.Организация КАК Организация,
		|	НеОбработанныеВходы.РаботникСклада КАК РаботникСклада,
		|	НеОбработанныеВходы.ДействиеВходаВыхода КАК ДействиеВходаВыхода,
		|	НеОбработанныеВходы.ПризнакОбработки КАК ПризнакОбработки,
		|	МИНИМУМ(ДанныеВходаВыходаРаботника.Дата) КАК ДатаВыхода,
		|	ДанныеВходаВыходаРаботника.ДействиеВходаВыхода КАК ДействиеВхода
		|ПОМЕСТИТЬ ДанныеВходаСближайшимВыходом
		|ИЗ
		|	НеОбработанныеВходы КАК НеОбработанныеВходы
		|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ДанныеВходаВыходаРаботника КАК ДанныеВходаВыходаРаботника
		|		ПО НеОбработанныеВходы.Дата <= ДанныеВходаВыходаРаботника.Дата
		|			И (ДанныеВходаВыходаРаботника.ДействиеВходаВыхода = ЗНАЧЕНИЕ(Перечисление.ДействияВходаВыхода.Выход))
		|			И НеОбработанныеВходы.РаботникСклада = ДанныеВходаВыходаРаботника.РаботникСклада
		|			И НеОбработанныеВходы.Организация = ДанныеВходаВыходаРаботника.Организация
		|ГДЕ
		|	НЕ ДанныеВходаВыходаРаботника.Дата ЕСТЬ NULL
		|
		|СГРУППИРОВАТЬ ПО
		|	НеОбработанныеВходы.Дата,
		|	НеОбработанныеВходы.Организация,
		|	НеОбработанныеВходы.РаботникСклада,
		|	НеОбработанныеВходы.ДействиеВходаВыхода,
		|	НеОбработанныеВходы.ПризнакОбработки,
		|	ДанныеВходаВыходаРаботника.ДействиеВходаВыхода
		|;
		|
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		|	ДанныеВходаСближайшимВыходом.Дата КАК Дата,
		|	ДанныеВходаСближайшимВыходом.Организация КАК Организация,
		|	ДанныеВходаСближайшимВыходом.РаботникСклада КАК РаботникСклада,
		|	ДанныеВходаСближайшимВыходом.ДействиеВходаВыхода КАК ДействиеВходаВыхода,
		|	ДанныеВходаСближайшимВыходом.ПризнакОбработки КАК ПризнакОбработкиВхода,
		|	ДанныеВходаСближайшимВыходом.ДатаВыхода КАК ДатаВыхода,
		|	ДанныеВходаВыходаРаботника.ПризнакОбработки КАК ПризнакОбработкиВыхода,
		|	РАЗНОСТЬДАТ(ДанныеВходаСближайшимВыходом.Дата, ДанныеВходаСближайшимВыходом.ДатаВыхода, ЧАС) КАК РазностьМеждуВременемВходаИВыхода
		|ИЗ
		|	ДанныеВходаСближайшимВыходом КАК ДанныеВходаСближайшимВыходом
		|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрСведений.ДанныеВходаВыходаРаботника КАК ДанныеВходаВыходаРаботника
		|		ПО ДанныеВходаСближайшимВыходом.ДатаВыхода = ДанныеВходаВыходаРаботника.Дата
		|			И ДанныеВходаСближайшимВыходом.РаботникСклада = ДанныеВходаВыходаРаботника.РаботникСклада
		|			И ДанныеВходаСближайшимВыходом.Организация = ДанныеВходаВыходаРаботника.Организация
		|			И ДанныеВходаСближайшимВыходом.ДействиеВхода = ДанныеВходаВыходаРаботника.ДействиеВходаВыхода";
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		Если ВыборкаДетальныеЗаписи.РазностьМеждуВременемВходаИВыхода>20 Тогда
			УстановитьПризнакОбработки(ВыборкаДетальныеЗаписи,ВыборкаДетальныеЗаписи.Дата,Перечисления.ДействияВходаВыхода.Вход);
			Продолжить;
		КонецЕсли;
		Если ПризнакОбработкиВыходаПоПараметрам(ВыборкаДетальныеЗаписи.ДатаВыхода,ВыборкаДетальныеЗаписи.РаботникСклада,ВыборкаДетальныеЗаписи.Организация) Тогда
			УстановитьПризнакОбработки(ВыборкаДетальныеЗаписи,ВыборкаДетальныеЗаписи.Дата,Перечисления.ДействияВходаВыхода.Вход);
            Продолжить;
		КонецЕсли;
		КоличествоДневныхЧасов=0;
		КоличествоНочныхЧасов=0;
		ДатаОтсчета=ВыборкаДетальныеЗаписи.Дата;
		Пока ДатаОтсчета< ВыборкаДетальныеЗаписи.ДатаВыхода Цикл 
			ДатаОтсчета=ДатаОтсчета+60*60;
			Если ДатаОтсчета> ВыборкаДетальныеЗаписи.ДатаВыхода Тогда 
				Продолжить;
			КонецЕсли;
			Если Час(ДатаОтсчета)=0 или Час(ДатаОтсчета)=12 Тогда 
				Продолжить;
			КонецЕсли;
			Если Час(ДатаОтсчета)<=22 и Час(ДатаОтсчета)>6 Тогда 
				КоличествоДневныхЧасов=КоличествоДневныхЧасов+1;
			иначе
				КоличествоНочныхЧасов=КоличествоНочныхЧасов+1;
			КонецЕсли;	
		КонецЦикла;
		Если КоличествоНочныхЧасов>0 Тогда 
			МенеджерЗаписи=РегистрыСведений.ФактическиеДанныеОЧасахРаботников.СоздатьМенеджерЗаписи();
			МенеджерЗаписи.Дата=НачалоДня(ВыборкаДетальныеЗаписи.Дата);
			МенеджерЗаписи.Организация=ВыборкаДетальныеЗаписи.Организация;
			МенеджерЗаписи.РаботникСклада=ВыборкаДетальныеЗаписи.РаботникСклада;
			МенеджерЗаписи.ВидУчетаВремени=Справочники.ВидыИспользованияРабочегоВремени.РаботаНочныеЧасы;
			МенеджерЗаписи.Прочитать();
			МенеджерЗаписи.Дата=НачалоДня(ВыборкаДетальныеЗаписи.Дата);
			МенеджерЗаписи.Организация=ВыборкаДетальныеЗаписи.Организация;
			МенеджерЗаписи.РаботникСклада=ВыборкаДетальныеЗаписи.РаботникСклада;
			МенеджерЗаписи.ВидУчетаВремени=Справочники.ВидыИспользованияРабочегоВремени.РаботаНочныеЧасы;
			МенеджерЗаписи.КоличествоЧасов=КоличествоНочныхЧасов;
			МенеджерЗаписи.Записать();
		КонецЕсли;
		Если КоличествоДневныхЧасов>0 Тогда 
			МенеджерЗаписи=РегистрыСведений.ФактическиеДанныеОЧасахРаботников.СоздатьМенеджерЗаписи();
			МенеджерЗаписи.Дата=НачалоДня(ВыборкаДетальныеЗаписи.Дата);
			МенеджерЗаписи.Организация=ВыборкаДетальныеЗаписи.Организация;
			МенеджерЗаписи.РаботникСклада=ВыборкаДетальныеЗаписи.РаботникСклада;
			МенеджерЗаписи.ВидУчетаВремени=Справочники.ВидыИспользованияРабочегоВремени.Явка;
			МенеджерЗаписи.Прочитать();
			МенеджерЗаписи.Дата=НачалоДня(ВыборкаДетальныеЗаписи.Дата);
			МенеджерЗаписи.Организация=ВыборкаДетальныеЗаписи.Организация;
			МенеджерЗаписи.РаботникСклада=ВыборкаДетальныеЗаписи.РаботникСклада;
			МенеджерЗаписи.ВидУчетаВремени=Справочники.ВидыИспользованияРабочегоВремени.Явка;
			МенеджерЗаписи.КоличествоЧасов=КоличествоДневныхЧасов;
			МенеджерЗаписи.Записать();
		КонецЕсли;
    УстановитьПризнакОбработки(ВыборкаДетальныеЗаписи,ВыборкаДетальныеЗаписи.Дата,Перечисления.ДействияВходаВыхода.Вход);
	УстановитьПризнакОбработки(ВыборкаДетальныеЗаписи,ВыборкаДетальныеЗаписи.ДатаВыхода,Перечисления.ДействияВходаВыхода.Выход);
...
Функция ПризнакОбработкиВыходаПоПараметрам(Дата,РаботникСклада,Организация)
	...
	Запрос.Текст = 
		...
		|	РегистрСведений.ДанныеВходаВыходаРаботника КАК ДанныеВходаВыходаРаботника
		|ГДЕ
		|	ДанныеВходаВыходаРаботника.Дата = &Дата
		|	И ДанныеВходаВыходаРаботника.Организация = &Организация
		|	И ДанныеВходаВыходаРаботника.РаботникСклада = &РаботникСклада
		|	И ДанныеВходаВыходаРаботника.ДействиеВходаВыхода = ЗНАЧЕНИЕ(Перечисление.ДействияВходаВыхода.Выход)";
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		Возврат ВыборкаДетальныеЗаписи.ПризнакОбработки;
	КонецЦикла;
	    Возврат Ложь;
КонецФункции
	
Процедура УстановитьПризнакОбработки(ВыборкаДетальныеЗаписи,Дата,ДействиеВходаВыхода)
МенеджерЗаписи=РегистрыСведений.ДанныеВходаВыходаРаботника.СоздатьМенеджерЗаписи();
МенеджерЗаписи.ДействиеВходаВыхода=ДействиеВходаВыхода;
МенеджерЗаписи.Организация=ВыборкаДетальныеЗаписи.Организация;
МенеджерЗаписи.РаботникСклада=ВыборкаДетальныеЗаписи.РаботникСклада;
...
МенеджерЗаписи.РаботникСклада=ВыборкаДетальныеЗаписи.РаботникСклада;
МенеджерЗаписи.Дата=Дата;
МенеджерЗаписи.ПризнакОбработки=Истина;
МенеджерЗаписи.Записать();
КонецПроцедуры
#КонецОбласти
