...
Процедура СохранитьНаСервере()
	Значение=итWMSПривилегированныйМодуль.ПолучитьНастройкиИзХранилища();
	Если ТипЗнч(Значение)=Тип("Структура") тогда
		Значение.Вставить("АдресаДоставкиПеремещение",АдресаДоставкиПеремещение.Выгрузить());
	иначе
		Значение=новый Структура("АдресаДоставкиПеремещение",АдресаДоставкиПеремещение.Выгрузить());
	КонецЕсли;	
...
Процедура Сохранить(Команда)
	СохранитьНаСервере();
	ВладелецФормы.ПодтянутьДанныеАдресовДоставкиПеремещение();
	ЭтаФорма.Закрыть();
КонецПроцедуры
