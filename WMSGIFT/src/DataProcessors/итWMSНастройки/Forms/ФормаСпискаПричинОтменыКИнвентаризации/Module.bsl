...
Процедура СохранитьНаСервере()
	Значение=итWMSПривилегированныйМодуль.ПолучитьНастройкиИзХранилища();
	Если ТипЗнч(Значение)=Тип("Структура") тогда
		Значение.Вставить("СписокПричинОтменыКИнвентаризации",СписокПричинОтменыКИнвентаризации.Выгрузить());
	иначе
		Значение=новый Структура("СписокПричинОтменыКИнвентаризации",СписокПричинОтменыКИнвентаризации.Выгрузить());
	КонецЕсли;	
...
Процедура Сохранить(Команда)
	СохранитьНаСервере();
	ВладелецФормы.ПодтянутьДанныеПричинОтменыКИнвентаризации();
	ЭтаФорма.Закрыть();
КонецПроцедуры
