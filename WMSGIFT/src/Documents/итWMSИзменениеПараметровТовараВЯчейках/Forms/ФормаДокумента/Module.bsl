...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	Если Параметры.Ключ.Пустая() тогда
		...
		КонецЕсли;
		Если Объект.ОрганизацияОтправитель.Пустая() Тогда
		ОбщегоНазначения.УстановитьОрганизациюВДокументе(Объект,"ОрганизацияОтправитель");
		КонецЕсли;
		Если Объект.ОрганизацияПолучатель.Пустая() Тогда
		ОбщегоНазначения.УстановитьОрганизациюВДокументе(Объект,"ОрганизацияПолучатель");
		КонецЕсли;
