...
//   *ТипКода - Число - возможные значения:
//      99 -  Авто выбор;
//      0 - EAN8;
//      1 - EAN13;
//      2 - EAN128;
...
//   *ТипВходныхДанных - Число - возможные значения: 
//   0 - Строка, 1 - Base64.
...
//
// Параметры: 
//   ПараметрыШтрихкода - см. ГенерацияШтрихкода.ПараметрыГенерацииШтрихкода - параметры штрихкода. 
//
// Возвращаемое значение: 
//   Структура:
