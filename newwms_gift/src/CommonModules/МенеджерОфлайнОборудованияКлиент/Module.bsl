...
Процедура ВыполнитьНастройкуОборудования(Идентификатор, ОповещениеПриЗавершении = Неопределено) Экспорт
	...
	ФормаНастройки = МенеджерОфлайнОборудованияКлиентПереопределяемый.ФормаНастройки(ПараметрыФормы.ОбработчикОфлайнОборудования);
	
	Если ЗначениеЗаполнено(ФормаНастройки) Тогда
...
Процедура НачатьВыполнениеКомандыОфлайнОборудования(ОповещениеПриЗавершении, Идентификатор, Контекст, ВходныеПараметры, ВыгрузкаДанных = Ложь) Экспорт
	...
	ОбработчикДрайвераМодуль = МенеджерОфлайнОборудованияКлиентПереопределяемый.ОбработчикДрайвераОфлайнОборудования(ОбработчикУстройстваОфлайн);
	...
	Если ОбработчикДрайвераМодуль = Неопределено Тогда
		...
		ВыполнитьОбработкуОповещения(ОповещениеПриЗавершении, РезультатВыполнения);
	Иначе
		Результат = ЗаполнениеПараметровУстройства(ОбработчикУстройстваОфлайн, ДанныеУстройстваОфлайн.Параметры);
...
Функция ЗаполнениеПараметровУстройства(ОбработчикУстройстваОфлайн, Параметры);
