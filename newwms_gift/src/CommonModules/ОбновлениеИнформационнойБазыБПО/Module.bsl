...
Процедура ОбработатьПодключаемоеОборудование(СсылкаНаОборудование) Экспорт
...
//
Процедура ОбработатьОфлайнОборудование(СсылкаНаПодключаемоеОборудование) Экспорт
