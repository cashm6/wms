...
Процедура ЗаполнитьТовар(СтруктураТовара, Товар)
	...
	ИначеЕсли Товар.Свойство("ЭтоМаркированнаяПродукция") Тогда
		...
		Если Товар.ЭтоМаркированнаяПродукция Тогда 
			Если Товар.ТипМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ТипыМаркировкиККТ.ТабачнаяПродукция") ИЛИ Товар.ВидМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ВидыМаркированнойПродукцииБПО.Табак") Тогда
				СтруктураТовара.type = "TOBACCO_MARKED";
			ИначеЕсли Товар.ТипМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ТипыМаркировкиККТ.ОбувныеТовары") ИЛИ Товар.ВидМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ВидыМаркированнойПродукцииБПО.Обувь") Тогда
			...
			ИначеЕсли Товар.ТипМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ВидыМаркированнойПродукцииБПО.МолочнаяПродукция") Тогда
				СтруктураТовара.type = "DAIRY_MARKED";
			ИначеЕсли Товар.ТипМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ВидыМаркированнойПродукцииБПО.Духи") Тогда
				СтруктураТовара.type = "PERFUME_MARKED";
			ИначеЕсли Товар.ТипМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ВидыМаркированнойПродукцииБПО.Фотоаппараты") Тогда
				СтруктураТовара.type = "PHOTOS_MARKED";
			ИначеЕсли Товар.ТипМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ВидыМаркированнойПродукцииБПО.Шины") Тогда
				СтруктураТовара.type = "TYRES_MARKED";
			ИначеЕсли Товар.ТипМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ВидыМаркированнойПродукцииБПО.ЛегкаяПромышленность") Тогда
				СтруктураТовара.type = "LIGHT_INDUSTRY_MARKED";
			ИначеЕсли Товар.ТипМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ВидыМаркированнойПродукцииБПО.АльтернативныйТабак") Тогда
		...
		ИначеЕсли Документ.type = "SELL" ИЛИ Документ.type = "PAYBACK" Тогда
			...
			Для Каждого Товар Из СтруктураТелаДокумента.positions Цикл
				...
				Если ЗначениеЗаполнено(Товар.mark) Тогда
					Если ТоварККМ.type = "ALCOHOL_MARKED" ИЛИ ТоварККМ.type = "TOBACCO_MARKED" Тогда
