...
// Функция - Проверка на организацию по метаданным
//
// Параметры:
//  Объект	 - СправочникОбъект,ДокументОбъект - 
//  Ссылка	 - СправочникСсылка,ДокументСсылка,Массив - 
//  ИмяРеквизита - Строка - имя реквизита в метаданных
//
// Возвращаемое значение:
//  Булево - истина если , организациясодержится в данном объекте, ложь в противном случае
//
