...
Процедура ВыгрузитьЗарегестрированныеИзменения(ДанныеОбработчика) Экспорт 
	...
	Если ЕстьНеНумерованныеИзменения(ТСД.УзелПланаОбмена) Тогда
	...
	|	И НЕ итWMSЗадачиТСДИзменения.НомерСообщения ЕСТЬ NULL
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
...
Функция ЕстьНеНумерованныеИзменения(УзелОбмена)
	...
	Запрос.Текст =
		...
		|	РегистрСведений.итWMSЗадачиТСД.Изменения КАК итWMSЗадачиТСДИзменения
		|ГДЕ
		|	итWMSЗадачиТСДИзменения.НомерСообщения ЕСТЬ NULL";
