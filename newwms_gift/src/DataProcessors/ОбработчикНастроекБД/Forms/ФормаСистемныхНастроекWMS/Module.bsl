...
СтруктураХраненияДанных=итWMSПривилегированныйМодуль.ПолучитьНастройкиИзХранилищаПоСвойствам("SSCCКарантина,GTINКарантина,CurrentDirectory,CurrentDirectoryDll");
