...
Процедура ПечатьЭтикеткиПаллетыКороба(ШтрихКод,Принтер) Экспорт 
	СтруктураНастроек=итWMSПривилегированныйМодуль.ПолучитьНастройкиИзХранилищаПоСвойствам("CurrentDirectoryDll,CurrentDirectory");
	...
	СтруктураПараметров.processorCapacity=32;
