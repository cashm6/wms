	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		...
		иначе
			Если ВыборкаДетальныеЗаписи.КоличествоПланЗаказа <> ВыборкаДетальныеЗаписи.КоличествоФакт Тогда 
				Сообщить("Количетсво номенклатуры "+Строка(ВыборкаДетальныеЗаписи.Номенклатура) +" в заказе не равно  набранному количеству в наборке (в заказе "+Строка(ВыборкаДетальныеЗаписи.КоличествоПланЗаказа)+ 
