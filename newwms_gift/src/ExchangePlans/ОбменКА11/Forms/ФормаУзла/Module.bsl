...
Процедура УстановитьСвязь(Команда)
	...
	Возврат
КонецЕсли;
ОткрытьФорму("ПланОбмена.ОбменКА11.Форма.ФормаУстановкиСвязи",новый Структура("IPАдресСервера,URLПространствоВебСервиса,ИмяПубликацииБазы,Ссылка",
...
Процедура ОбработкаВыбора(ВыбранноеЗначение, ИсточникВыбора)
	Если ИсточникВыбора.ИмяФормы="ПланОбмена.ОбменКА11.Форма.ФормаУстановкиСвязи" Тогда 
